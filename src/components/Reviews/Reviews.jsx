...
const ReviewList = () => {
  ...
  useEffect(() => {
    setReviews([
      ...
      },
      {
        ...
        avatar: "https://cdn.discordapp.com/attachments/1151870132549865536/1160301761467265166/1675242775823.jpg?ex=65342a39&is=6521b539&hm=c1bfe95360778ee13ec630cb38106e74b6695e519ff7aec54f080a0ea02d4d5f&",
      },
      {
        id: 3,
        name: "Bob Johnson",
        ...
        avatar: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
      },
      {
        id: 4,
        name: "Alice Brown",
        ...
        avatar: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2080&q=80",
      },
      {
        id: 5,
        name: "Charlie Wilson",
  ...
  return (
    <div style={{ minHeight: '200vh' }} className="relative flex flex-col px-4 pt-24  sm:px-6 lg:px-8">
      <div className="flex-1 space-y-8">
        {reviews.map((review, index) => (
          <Review key={review.id} review={review} index={index} />
        ))}
        <h1 className="text-center text-2xl font-extrabold lg:text-5xl my-8 text-blue-500"><span>500+</span> Happy Customer</h1>
      </div>
